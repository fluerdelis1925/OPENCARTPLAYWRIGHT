...
Expected: "Warning: No Match for E-mail and/or Password."
...
> 35 |          await expect(errorMessage).toBe('Warning: No Match for E-mail and/or Password.'); //Validate that the expected error message is displayed
     |                                     ^ Error: expect(received).toBe(expected) // Object.is equality
  36 |       }
  37 |     
  38 |    })
