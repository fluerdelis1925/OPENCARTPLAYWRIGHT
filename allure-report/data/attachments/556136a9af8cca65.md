...
Expected: "Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour."
...
> 35 |          await expect(errorMessage).toBe('Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.'); //Validate that the expected error message is displayed
     |                                     ^ Error: expect(received).toBe(expected) // Object.is equality
  36 |       }
  37 |     
  38 |    })
